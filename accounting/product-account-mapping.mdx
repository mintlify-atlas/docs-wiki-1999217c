...
| `interestOnLoansAccountId` | `INTEREST_ON_LOANS (3)` | INCOME |
| `incomeFromFeesAccountId` | `INCOME_FROM_FEES (4)` | INCOME |
| `incomeFromPenaltiesAccountId` | `INCOME_FROM_PENALTIES (5)` | INCOME |
