...
Both classes reside in `org.apache.fineract.portfolio.savings.domain` inside **fineract-provider** (`fineract-provider/src/main/java/org/apache/fineract/portfolio/savings/domain/`).
