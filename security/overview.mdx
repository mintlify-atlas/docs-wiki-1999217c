...
|-------|---------|---------|
| 1 | `/swagger-ui/**`, `/fineract.json`, `/actuator/**`, `/legacy-docs/apiLive.htm` | Public endpoints — `permitAll`, no JWT |
